...
library(caret)
a=confusionMatrix(test_ad_data2$Ad_Class,pred)
a
a=as.table(a)
Overall_error=94

#Exporting Confusion Matrix and OverallError
write.csv(a,"Problem2_confusionmatrix_logisticregresion.csv")
write.csv(Overall_error,"Problem2_Overallerrorrate_logisticregression.csv",row.names=FALSE)
