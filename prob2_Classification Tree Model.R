...
write(capture.output(table(prune.pred, Ad_Class.test)),"Problem2_confusionmatrix_ClassificationTREES.csv")
write.csv(Overall_error,"Problem2_Overallerrorrate_ClassificationTREES.csv",row.names=FALSE)
